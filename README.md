...
####  接下来要做的
1、根据mab进行数据质量评分，估计需要修改逻辑架构 3days<br>
2、修改通信相关参数，检查通信时延计算是否有误 2days<br>
3、修改模型训练，划分出验证集 2days<br>
4、遗忘指标计算 1day<br>
5、在metrics.py中添加数据分布显示图，参考Joint class论文 2days<br>
6、修改main.py，进行基线对比实验 10days<br>
7、消融实验 5days<br>
8、完善digit和dominNet数据集训练 7days<br>
最佳预期：预计12月底完成。