...
if __name__ == "__main__":
    ...
    print("测试 IncrementalMetricsCalculator...\n")
    # 模拟一些数据
    seen_domains = ['domain1', 'domain2', 'domain3']
    accuracy_history = {
        'domain1': [0.6, 0.65, 0.7],
        'domain2': [0.5, 0.6],
        'domain3': [0.4],
    }
    metrics = IncrementalMetricsCalculator.compute_metrics(seen_domains, accuracy_history)
    print("Computed Metrics:", metrics)
    aia = IncrementalMetricsCalculator.compute_aia([0.6, 0.625, 0.65])
    print("Computed AIA:", aia)
